...
public class Vector2D {
	 ...
	 * @return True if neither operand is the zero vector and the operands have
	 *         the same slope (regardless of direction).
	 */
	...
	/**
	 * @return The length of this vector squared. (Use this to save square
	 *         roots).
	 */
